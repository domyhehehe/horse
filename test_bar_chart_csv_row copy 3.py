...
FINAL_HOLD_STEPS = 30
# 🎬 動画の予測時間を計算
initial_time_sec = INITIAL_BLANK_STEPS / FPS
horses_display_time_sec = (TOP_HORSES - INITIAL_DISPLAY_COUNT) * SECONDS_PER_HORSE
final_hold_time_sec = FINAL_HOLD_STEPS / FPS
total_time_sec = initial_time_sec + horses_display_time_sec + final_hold_time_sec
...
# 予測時間を表示
print(f"⏱️ 予測動画時間: {minutes}分 {seconds}秒 （合計: {total_time_sec:.2f}秒）")
